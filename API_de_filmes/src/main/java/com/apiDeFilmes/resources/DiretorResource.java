...
public class DiretorResource {
	...
	public ResponseEntity<?> insert(@RequestBody Diretor obj){
	...
	public ResponseEntity<?> update(@RequestBody Diretor obj, @PathVariable Integer id){
